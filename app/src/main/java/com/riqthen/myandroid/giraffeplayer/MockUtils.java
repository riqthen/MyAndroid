...
//        imgs.add("http://orewrc0vz.bkt.clouddn.com/testMovie.mp4");
//        imgs.add("http://orewrc0vz.bkt.clouddn.com/testMovie.mp4");
        imgs.add("http://orewrc0vz.bkt.clouddn.com/testMovie.mp4");
//        imgs.add(Environment.getExternalStorageDirectory().getPath()+"/DCIM/demo1.avi");
        imgs.add(Environment.getExternalStorageDirectory().getPath()+"/DCIM/demo2.avi");
//        imgs.add(Environment.getExternalStorageDirectory().getPath()+"/DCIM/demo3.mp4");
//        return imgs.get(new Random().nextInt(imgs.size()));
        return imgs.get(1);
    }
